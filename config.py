...
def argparser(is_train=True):
    ...
    parser.add_argument('--valhdf5FileName', type=str, default='validate_MRIdata_3_AD_MCI_Normal.hdf5',
                        choices=['validate_MRIdata_3_AD_MCI_Normal.hdf5', 'validate_MRIdata_2_AD_MCI.hdf5',
                                 'validate_MRIdata_2_AD_Normal.hdf5', 'validate_MRIdata_2_MCI_Normal.hdf5',
                                 'data.hdf5'])
    parser.add_argument('--validFileName', type=str, default='validate_MRIdata_3_AD_MCI_Normal_id.txt',
                        choices=['validate_MRIdata_3_AD_MCI_Normal_id.txt', 'validate_MRIdata_2_AD_MCI_id.txt',
                                 'validate_MRIdata_2_AD_Normal_id.txt', 'validate_MRIdata_2_MCI_Normal_id.txt',
                                 'id.txt'])
    ...
    parser.add_argument('--batch_size_label', type=int, default=7)
    parser.add_argument('--batch_size_unlabel', type=int, default=7)
    ...
    parser.add_argument('--tt_rank_G', type=int, default=7)

    parser.add_argument('--split_dimension_core_C', type=int, default=3)
    parser.add_argument('--tt_rank_C', type=int, default=19)
