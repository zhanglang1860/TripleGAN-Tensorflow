...
python GAN_train.py --train --test --hdf5FileNametrain train_MRIdata_2_MCI_Normal.hdf5 --idFileNametrain train_MRIdata_2_MCI_Normal_id.txt --testhdf5FileName test_MRIdata_2_MCI_Normal.hdf5 --testidFileName test_MRIdata_2_MCI_Normal_id.txt  --valhdf5FileName validate_MRIdata_2_MCI_Normal.hdf5 --validFileName validate_MRIdata_2_MCI_Normal_id.txt --gpu_id 0 --depth 40 --growth_rate 12 --reduction 1 --model_type DenseNet


python GAN_train.py --train --test --hdf5FileNametrain train_MRIdata_2_MCI_Normal.hdf5 --idFileNametrain train_MRIdata_2_MCI_Normal_id.txt --testhdf5FileName test_MRIdata_2_MCI_Normal.hdf5 --testidFileName test_MRIdata_2_MCI_Normal_id.txt  --valhdf5FileName validate_MRIdata_2_MCI_Normal.hdf5 --validFileName validate_MRIdata_2_MCI_Normal_id.txt --gpu_id 1 --depth 30 --growth_rate 12 --reduction 0.5 --model_type DenseNet



python GAN_train.py --train --test --hdf5FileNametrain train_MRIdata_2_MCI_Normal.hdf5 --idFileNametrain train_MRIdata_2_MCI_Normal_id.txt --testhdf5FileName test_MRIdata_2_MCI_Normal.hdf5 --testidFileName test_MRIdata_2_MCI_Normal_id.txt  --valhdf5FileName validate_MRIdata_2_MCI_Normal.hdf5 --validFileName validate_MRIdata_2_MCI_Normal_id.txt --gpu_id 2 --depth 30 --growth_rate 12 --reduction 1 --model_type DenseNet


python GAN_train.py --train --test --hdf5FileNametrain train_MRIdata_2_MCI_Normal.hdf5 --idFileNametrain train_MRIdata_2_MCI_Normal_id.txt --testhdf5FileName test_MRIdata_2_MCI_Normal.hdf5 --testidFileName test_MRIdata_2_MCI_Normal_id.txt  --valhdf5FileName validate_MRIdata_2_MCI_Normal.hdf5 --validFileName validate_MRIdata_2_MCI_Normal_id.txt --gpu_id 3
...
python GAN_train.py --train --test --hdf5FileNametrain train_MRIdata_2_AD_MCI.hdf5 --idFileNametrain train_MRIdata_2_AD_MCI_id.txt --testhdf5FileName test_MRIdata_2_AD_MCI.hdf5 --testidFileName test_MRIdata_2_AD_MCI_id.txt --valhdf5FileName validate_MRIdata_2_AD_MCI.hdf5 --validFileName validate_MRIdata_2_AD_MCI_id.txt --gpu_id 3  --reduction 1
